...
class BankWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return      Expanded(
                ...
                SizedBox(height: 16,),
                Center(
                child:Text( "Connect your bank account to pay rent and to substitute proof of income and employment documents.",textAlign: TextAlign.center,)),
                SizedBox(height: 5),
                AddBankButtonButton(),
                ...
                InkWell(
                child: 
                new Text("Payment History",style:TextStyle(color: Colors.amber, 
